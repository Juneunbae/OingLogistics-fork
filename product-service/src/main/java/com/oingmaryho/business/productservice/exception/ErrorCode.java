...
public enum ErrorCode {
	...
	INVALID_PRODUCT_NAME("P-004", "상품명은 공백이 될 수 없습니다.", HttpStatus.BAD_REQUEST),
	INVALID_PRICE("P-005", "가격은 0보다 커야 합니다.", HttpStatus.BAD_REQUEST),
	INVALID_STOCK("P-006", "재고는 0보다 작을 수 없습니다.", HttpStatus.BAD_REQUEST);
	;
