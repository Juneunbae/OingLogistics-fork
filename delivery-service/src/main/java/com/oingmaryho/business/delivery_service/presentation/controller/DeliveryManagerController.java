...
public class DeliveryManagerController {
    ...
    @Description(
            "허브 관리자, 허브 배송 담당자, 업체 배송 담당자 - 배송 담당자 상세 조회"
    )
    @RequiredRoles({
    ...
    public ResponseEntity<DeliveryManagerResponseDto> getDeliveryManagerDetail(
        ...
        DeliveryManagerResponseServiceDto responseServiceDto = deliveryService.GetDeliveryManagerDetail(
                userId,
                userRole,
                requestServiceDto);
    ...
    @Description(
            "허브 관리자, 허브 배송 담당자, 업체 배송 담당자 - 배송 담당자 검색"
    )
    @RequiredRoles({
            UserRoleType.HUB_MANAGER,
            UserRoleType.HUB_DELIVERY_MANAGER,
    ...
    public ResponseEntity<Page<DeliveryManagerResponseDto>> searchDeliveryManager(
        ...
        Page<DeliveryManagerResponseServiceDto> responseServiceDtos = deliveryService.GetDeliveryManagerBySearch(
                userId,
                userRole,
                requestServiceDto);
